...
public class TestParser {
   ...
   public void testTestngXmlWithExistingResultXml() {
      ...
      JasonNGResult results = CommonUtil.getResults(resource.getFile());
   ...
   public void testTestngXmlWithNonExistingResultXml() {
      JasonNGResult results = CommonUtil.getResults("/invalid/path/to/file/new-test-result.xml");
   ...
   public void parseTestNG() {
      JasonNGResult results = CommonUtil.getResults(CommonUtil.getResource(Constants.TESTNG_XML_TESTNG).getFile());
      results.tally();
   }

   @Test
   public void testParseEmptyException() {
      JasonNGResult results = CommonUtil.getResults(CommonUtil.getResource(Constants.TESTNG_XML_EMPTY_EXCEPTION).getFile());
      results.tally();
