package hudson.plugins.jasonng.parser;

import hudson.FilePath;
import hudson.plugins.jasonng.results.*;
...
public class ResultsParser {
    ...
    */
   private Map<String, JasonNGTestResult> testResultMap = new HashMap<String, JasonNGTestResult>();
   /*
   ...
   private JasonNGResult finalResults;
   private List<JasonNGTestResult> testList;
   ...
   private JasonNGTestResult currentTest;
   ...
   public JasonNGResult parse(FilePath[] paths) {
      ...
      for (FilePath path : paths) {
         ...
         try {
            ...
            //some initial setup
            testList = new ArrayList<JasonNGTestResult>();
   ...
   private void startTest(String name)
   {
      if (testResultMap.containsKey(name)) {
         ...
         currentTest = new JasonNGTestResult(name);
