 ...
 * @author farshidce
 */
public class JasonNGResult extends BaseResult implements Serializable {

    private static final long serialVersionUID = -3491974223665601995L;
    private List<JasonNGTestResult> testList = new ArrayList<JasonNGTestResult>();
     ...
     */
    public JasonNGResult(String name) {
        super(PluginImpl.URL);
    }

    public JasonNGResult() {
        super(PluginImpl.URL);
    }
    ...
    public List<JasonNGTestResult> getTestList() {
        return testList;
    }
    ...
    public void addUniqueTests(List<JasonNGTestResult> testList) {
        Set<JasonNGTestResult> tmpSet = new HashSet<JasonNGTestResult>(this.testList);
        tmpSet.addAll(testList);
        this.testList = new ArrayList<JasonNGTestResult>(tmpSet);
    }
    ...
    public boolean equals(Object o) {
        ...
        JasonNGResult testngResult = (JasonNGResult) o;
    ...
    public void tally() {
        ...
        packageMap.clear();
        for (JasonNGTestResult _test : testList) {
