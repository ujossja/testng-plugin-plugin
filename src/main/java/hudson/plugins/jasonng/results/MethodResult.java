...
public class MethodResult extends BaseResult {
    ...
    private void addData(DataSetBuilder<String, ChartUtil.NumberOnlyBuildLabel> dataSetBuilder,
        ...
        JasonNGTestResultBuildAction action = build.getAction(JasonNGTestResultBuildAction.class);
        JasonNGResult results;
     ...
     */
    private MethodResult getMethodResult(JasonNGResult results) {
