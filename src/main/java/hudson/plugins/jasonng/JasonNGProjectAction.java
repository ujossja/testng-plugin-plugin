...
import hudson.plugins.jasonng.util.GraphHelper;
 ...
 * @author nullin
 */
public class JasonNGProjectAction extends TestResultProjectAction implements ProminentProjectAction {
   ...
   public JasonNGProjectAction(AbstractProject<?, ?> project,
   ...
   protected Class<JasonNGTestResultBuildAction> getBuildActionClass() {
      return JasonNGTestResultBuildAction.class;
   }
   ...
   public JasonNGTestResultBuildAction getLastCompletedBuildAction() {
      for (AbstractBuild<?, ?> build = getProject().getLastCompletedBuild();
               build != null; build = build.getPreviousCompletedBuild()) {
         final JasonNGTestResultBuildAction action = build.getAction(getBuildActionClass());
         if (action != null) {
            return action;
         }
      }
   ...
   protected void populateDataSetBuilder(DataSetBuilder<String, ChartUtil.NumberOnlyBuildLabel> dataset) {
      ...
      for (AbstractBuild<?, ?> build = getProject().getLastBuild();
         ...
         JasonNGTestResultBuildAction action = build.getAction(getBuildActionClass());
