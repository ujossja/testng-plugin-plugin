...
public class BuildActionConverter implements Converter {
    ...
    public boolean canConvert(@SuppressWarnings("rawtypes") Class type) {
        return JasonNGTestResultBuildAction.class == type;
    }

    /**
     * Marshals out the {@link JasonNGTestResultBuildAction} object.
     * <p/>
    ...
    public void marshal(Object source, HierarchicalStreamWriter writer,
        ...
        JasonNGTestResultBuildAction action = (JasonNGTestResultBuildAction) source;
    ...
    public Object unmarshal(final HierarchicalStreamReader reader,
        ...
        JasonNGTestResultBuildAction action = new JasonNGTestResultBuildAction(null, null);
        reader.moveDown();
        Class type = context.getRequiredType();
        AbstractBuild build = (AbstractBuild) context.convertAnother(action, type);
        reader.moveUp();
        action = new JasonNGTestResultBuildAction(build, action.getResult(build));
